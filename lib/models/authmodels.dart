...
class driveruser {
  ...
  driveruser({this.commission, this.name, this.phone, this.vehicalname, this.vechicalnuber});
...
Stream<driveruser> sp(){
  ...
  Future<void> getdetailes(String phone) async{
    print(phone);

    var doc = await   driverdata.document(phone).get();
    var check = doc.data;
